...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/chat',
            ...
            async function ChatController_getChat(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getChat.apply(controller, validatedArgs as any);
        ...
        app.get('/health/status',
            ...
            async function HealthController_checkStatus(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/health/health',
            ...
            async function HealthController_checkHealth(request: any, response: any, next: any) {
            const args = {
            };
